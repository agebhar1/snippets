...
> [!NOTE]
> The use of **the [OpenTelemetry Agent](https://opentelemetry.io/docs/zero-code/java/agent/) is not needed nor recommended**. Quarkus Extensions and the libraries they provide,
